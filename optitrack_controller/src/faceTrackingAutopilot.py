...
class faceTrackingAutopilot():
    ...
    def publish_switched_cmd_vel_msg(self):
        if(self.logging):
            ...
            self.data_logger.write(("fta.face.switched_cmd_vel_msg.linear({},:) = [{:06.8f} {:06.8f} {:06.8f}];\n").format(self.switched_cmd_vel_counter, self.mocap_vel_msg.linear.x, self.mocap_vel_msg.linear.y, fta.mocap_vel_msg.linear.z))
            self.data_logger.write(("fta.face.switched_cmd_vel_msg.angular({},:) = [{:06.8f} {:06.8f} {:06.8f}];\n\n").format(self.switched_cmd_vel_counter, self.mocap_vel_msg.angular.x, self.mocap_vel_msg.angular.y, fta.mocap_vel_msg.angular.z))
