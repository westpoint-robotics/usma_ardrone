...
#ifndef ARDRONE_STATE_CONTROLLER_H
#define ARDRONE_STATE_CONTROLLER_H
...
class ArdroneStateController : public ModelPlugin
{
public:
  ArdroneStateController();
  virtual ~ArdroneStateController();
...
#endif // ARDRONE_STATE_CONTROLLER_H
